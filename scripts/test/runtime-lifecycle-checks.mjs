...
async function main() {
  ...
  ok('surface: DOMAINS gained GATE and GATE_SET, namespaced, all existing domains unchanged', DOMAINS.GATE === 'maddu.runtime.v1/gate' && DOMAINS.GATE_SET === 'maddu.runtime.v1/gate_set' && DOMAINS.EVENT === 'maddu.runtime.v1/event' && DOMAINS.MANIFEST === 'maddu.runtime.v1/manifest' && Object.keys(DOMAINS).length === 7);
