...
async function main() {
  ...
  ok('surface: DOMAINS gained GATE and GATE_SET (P3), ACTION and DECISION (P4), RECEIPT (P5), namespaced, all existing domains unchanged', DOMAINS.GATE === 'maddu.runtime.v1/gate' && DOMAINS.GATE_SET === 'maddu.runtime.v1/gate_set' && DOMAINS.ACTION === 'maddu.runtime.v1/action' && DOMAINS.DECISION === 'maddu.runtime.v1/decision' && DOMAINS.RECEIPT === 'maddu.runtime.v1/receipt' && DOMAINS.EVENT === 'maddu.runtime.v1/event' && DOMAINS.MANIFEST === 'maddu.runtime.v1/manifest' && Object.keys(DOMAINS).length === 10);
