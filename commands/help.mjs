...
const ROSTER = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '/maddu-handoff [<markdown> | show]', line: 'Set or show the curated "▶ RESUME HERE" cross-session handoff.', under: 'handoff set, handoff show' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '/maddu-governance [show | set <tier>]', line: 'Switch or show the governance tier; hard rules immutable regardless.', under: 'governance show, governance set' },
      { name: '/maddu-log',     line: 'Audited receipt log; filter by --since / --lane / --op.',       under: 'log' },
      { name: '/maddu-plugin [list | info | enable | disable <name>]', line: 'Capabilities that live outside the core.', under: 'plugin' },
