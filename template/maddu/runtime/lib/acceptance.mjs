...
// `spawnSync`); nothing in that graph runs at import time, and this file reads
// no spine. (Since phase 2a it DOES spawn and DOES write — but only from
// `runAcceptanceCommand` and `withAcceptanceLock`, never from anything above.)
