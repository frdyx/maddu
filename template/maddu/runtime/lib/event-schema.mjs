...
export const EVENT_SCHEMA = {
  ...
  SPINE_CUTOVER: { summary: "A chain-local tamper-evidence cutover anchor (seeded into a freshly-minted sync partition so verify holds it to the post-cutover strict rules).", data: { version: 'string' } },
