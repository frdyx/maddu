...
export const EVENT_SCHEMA = {
  ...
  MEMORY_INJECTED: { summary: "Approved memory facts were injected into an agent brief (bounded recall packet; facts[] records each fed fact's approval content-hash).", data: { factIds: 'array', facts: 'array', lane: 'string|null', query: 'string', sessionId: 'string|null', totalBytes: 'number' } },
