...
export const EVENT_DISPOSITIONS = {
  ...
  SKILL_CREATED: { disp: 'dormant', reason: "skill funnel terminal — pending F2 surfacing (roadmap #5); 0 conversion across the fleet" },
  SKILL_UPDATED: { disp: 'dormant', reason: "skill funnel terminal — pending F2 surfacing (roadmap #5); 0 conversion across the fleet" },
  SKILL_DELETED: { disp: 'dormant', reason: "skill funnel terminal — pending F2 surfacing (roadmap #5); 0 conversion across the fleet" },
  SKILL_APPLIED: { disp: 'dormant', reason: "skill funnel terminal — pending F2 surfacing (roadmap #5); 0 conversion across the fleet" },
  ...
  SKILL_INJECTED: { disp: 'dormant', reason: "skill funnel terminal — pending F2 surfacing (roadmap #5); 0 conversion across the fleet" },
  ...
  SKILL_CANDIDATE_DETECTED: { disp: 'active' },
  SKILL_CANDIDATE_APPROVED: { disp: 'dormant', reason: "skill funnel terminal — pending F2 surfacing (roadmap #5); 0 conversion across the fleet" },
  SKILL_CANDIDATE_REJECTED: { disp: 'dormant', reason: "skill funnel terminal — pending F2 surfacing (roadmap #5); 0 conversion across the fleet" },
  ...
  SKILL_IMPORTED: { disp: 'dormant', reason: "skill funnel terminal — pending F2 surfacing (roadmap #5); 0 conversion across the fleet" },
  SKILL_TRUSTED: { disp: 'dormant', reason: "skill funnel terminal — pending F2 surfacing (roadmap #5); 0 conversion across the fleet" },
