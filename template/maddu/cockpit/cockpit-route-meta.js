...
export const ROUTE_META = {
  ...
  decisions:  { title: 'Decisions',  group: 'verify',   rank: 13,                description: 'Decision ledger — the curated decision-grade spine (intent set · approvals + forced claims + drift triggers · failing gates · goal completed), each row carrying actor, provenance (human vs which auto-trigger), and its tamper-detecting stored-line SHA that ties back to the verified chain. Read-time derivation, zero writes.',
                keywords: 'decisions ledger audit provenance approval goal gate trigger sha chain tamper-detecting accountability who-decided' },
  oversight:  { title: 'Oversight',  group: 'verify',   rank: 12,                description: 'The non-coder oversight readout — what the agent DID with a skill: fed vs WITHHELD (and why, in plain language), whether it stayed on your goal, on a tamper-detecting record you can independently verify. Read-time derivation, zero writes. Accountability substrate, not a safety proof.',
