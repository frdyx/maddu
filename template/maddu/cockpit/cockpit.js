...
const RENDERERS = {
  ...
  dashboard: renderDashboard, roadmap: renderRoadmap, skills: renderSkills, docs: renderDocs, focus: renderFocus, experience: renderExperience, model: renderModel, oversight: renderOversight,
};
const ROUTES = {};
