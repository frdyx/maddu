...
- Design contract: `docs/research/competitive-response-proposal.md` (local), plan `pln_20260705002732_7773` phases 1–5 (#12a needs only phase 6 doctor-matrix). Self-test 112/112; audit 16/0 (162 event types reachable); `maddu ci` green. Self-test latency baseline raised 36s→48s→115s across the arc (attribution recorded in `docs/audit/governance-budget.json` — the dominant driver is ci-command invoking `maddu ci` 7×, whose per-run cost grew with the #12 surface).
